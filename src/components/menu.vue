<template>
	<div class="menu">
		...
		<h1 style="font-size: 30px; font-weight:bold; padding: 1%;">
			{{ msg }}
		</h1>

		<button class="button is-dark is-large" style="width: 90%; margin: 0.5%;" @click="toDo(index, menu)" v-for="(menu, index) in menu_lists" v-show="menu.is_create==1">
			{{ menu.menuname }}
		</button>
