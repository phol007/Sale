	    		 ...
	    		 <table class="tableSection">
                        ...
                        <tbody>
                            <tr v-for="(item_list, index) in sortedList" @dblclick="selectTR(item_list)" class="item_list_label" @click="show_stock(index, item_list)">
                            	...
                            	<td style="padding:0;">
                            		<input type="text" placeholder="0.00" v-model="item_list.price" @change="calNetAmount(index, unit_list, item_list.qty, item_list.price, item_list.discount, item_list.amount)" @click="return_Int_Item(index, '', item_list.price, '')" @focus="return_Int_Item(index, '', item_list.price, '')" @blur="return_FM_Item(index, item_list.qty, item_list.price, item_list.discount)" :readonly="is_confirm==1||is_cancel==1 || user.roleid < 4" class="item_list_input2" @keydown="keyNumber">
                            	</td>
                            	<td style="padding:0;">
